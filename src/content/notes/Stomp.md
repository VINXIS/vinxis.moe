...
U cannot trigger multiple at the same time

Immediaetly when 1 stomp ends tho u can trigger the next 1
## Interactions

[[Stomp]]s can be cancelled by [[Elevate]], [[Godspeed]], [[Fireball]], and [[Book of Life]].

A caveat with [[Elevate]]: u can cancel the ground pounding, but u will still drop at -70 speed

Stomping a [[Purify]] will also trigger a bomb earlier if u stomp/ground pound on it

#unconfirmed [[Stomp]]s can maybe get cancelled by [[Dominion]]'s grapple as well(?)